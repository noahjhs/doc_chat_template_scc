...
static void setStatusItemStateImage(const char *titlePrefix, const void *pngBytes, int pngLen) {
...
func setStatusDotIcon(titlePrefix string, png []byte) {
	...
	C.setStatusItemStateImage(cPrefix, unsafe.Pointer(&png[0]), C.int(len(png)))
}
